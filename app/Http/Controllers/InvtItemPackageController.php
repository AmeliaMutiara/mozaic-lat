...
class InvtItemPackageController extends Controller
{
    public function processAddItem(Request $request)
    {
        ...
        if ($item) {
            $data = "<tr class='pkg-item'>
                        ...
                        <td>
                            <div class='row'>
                                <input oninput='function_change_quantity(".$request->item_id.",".$request->item_id.", this.value)'
                                ...
                                <div class='col-auto'>".$unit."</div>
                            </div>
                        </td>
                        <td class='text-center'>
                            <button type='button' class='btn btn-outline-danger btn-sm' onclick='deleteIsiPaket('".$request->item_id."'.'".$request->item_unit."','". route('package.delete')."')'>Hapus</button>
                        </td>
                    </tr>
                ";
            $arr=[$request->item_id=>[$qty,$request->item_id]];
