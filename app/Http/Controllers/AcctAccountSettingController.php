...
class AcctAccountSettingController extends Controller
{
    public function index()
    {
        ...
        return view('content.AcctAccountSetting.index', compact('accountlist', 'status'));
    }
    ...
    public function processAddAcctAccountSetting(Request $request)
    {
        $data = array(
            ...
            '3_account_id'               => $request->input('purchase_cash_payment_account_id'),
            '3_account_setting_status'   => $request->input('purchase_cash_payment_account_status'),
            '3_account_setting_name'     => 'purchase_cash_payment_account',
