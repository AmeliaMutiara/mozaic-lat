...
class ChildDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', 'content.ContohTable.Detail._action-menu')
            ->setRowId('id');
    }
    ...
    {
        return $model->newQuery()->where('parent_id',$this->parent_id);
    }
    ...
    {
        return [
            Column::make('child_id')->title(__('No'))->data('DT_RowIndex') ->addClass('text-center')->width(10),
