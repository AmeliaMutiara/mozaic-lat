...
<script>
    $(document).ready(function(){
        ...
        if (item_quantity_1 == '' && $('#item_unit_1').val() == '') {
            $('#item_unit_id_1').select2('val',0);
        }
        if (item_quantity_2 == '' && $('#item_unit_2').val() == '') {
            $('#item_unit_id_2').select2('val','0');
        }
        if (item_quantity_3 == '' && $('#item_unit_3').val() == '') {
            $('#item_unit_id_3').select2('val','0');
        }
        if (item_quantity_4 == '' && $('#item_unit_4').val() == '') {
...
@endif
    ...
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ url()->previous() }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>

    <form method="post" action="{{ route('item.process-edit',$origin) }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
                                ...
                                <div class="row form-group mt-2">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="item_unit_1" id="item_unit_1" value="{{$row['item_unit_id']}}"/>
                                            {!! Form::select('item_unit_id', $itemunits, $row['item_unit_id'],["autocomplete"=>"off",'class' => 'form-control selection-search-clear select-form','name'=>'item_unit_id_1','id'=>'item_unit_id_1']) !!}  
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="row form-group mt-2">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="item_unit_2" id="item_unit_2" value="{{$row['item_unit_id']}}"/>
                                            {!! Form::select('item_unit_id', $itemunits, $row['item_unit_id'],["autocomplete"=>"off",'class' => 'form-control selection-search-clear select-form','name'=>'item_unit_id_2','id'=>'item_unit_id_2']) !!}  
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                        ...
                        @if ($row['order'] == 3)
                            <div class="mt-5">
                                ...
                                <div class="row form-group mt-2">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="hidden" name="item_unit_3" id="item_unit_3" value="{{$row['item_unit_id']}}"/>
                                            <a class="text-dark">Satuan Barang 3</a>
                                            {!! Form::select('item_unit_id', $itemunits, $row['item_unit_id'],["autocomplete"=>"off",'class' => 'form-control selection-search-clear select-form','name'=>'item_unit_id_3','id'=>'item_unit_id_3']) !!}  
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                        ...
                        @if ($row['order'] == 4)
                            <div class="mt-5">
                                ...
                                <div class="row form-group mt-2">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="hidden" name="item_unit_4" id="item_unit_4" value="{{$row['item_unit_id']}}"/>
                                            <a class="text-dark">Satuan Barang 4</a>
                                            {!! Form::select('item_unit_id', $itemunits, null ,["autocomplete"=>"off",'class' => 'form-control selection-search-clear select-form','name'=>'item_unit_id_4','id'=>'item_unit_id_4']) !!}  
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
