...
<script>
    ...
    function function_elements_addz(name, value){
...
@endif
    ...
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ url('item.index') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>

    <form method="post" action="{{ route('item.add-process') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
