...
<td class="text-center">
    <a type="button" href="{{route('acct-account.edit',$model->account_id)}}" class="btn btn-sm btn-primary btn-active-light-primary">
       Edit
    </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" href="{{route('acct-account.delete',$model->account_id)}}" class="btn btn-danger">
                    Ya
                 </a>
            </div>
        </div>
