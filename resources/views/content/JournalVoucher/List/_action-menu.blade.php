...
<div class="modal fade" tabindex="-1" id="modal_delete_{{ $model->journal_voucher_id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" href="{{route('jv.delete',$model->journal_voucher_id)}}" class="btn btn-success">
                    Ya
                 </a>
            </div>
        </div>
