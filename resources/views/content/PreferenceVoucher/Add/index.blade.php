...
{{-- <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ route('pv.index') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>

    <form method="post" action="{{ route('pv.add-process') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
