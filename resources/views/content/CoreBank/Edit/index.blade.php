...
@endif
    ...
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ route('core-bank') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>

    <form method="post" action="{{ route('core-bank/process-edit') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
